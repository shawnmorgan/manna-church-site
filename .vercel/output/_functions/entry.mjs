...
var middlewareSecret = "4134a5b4-5c80-4314-bf09-cb30991d11a8";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/shawnmorgan/Desktop/Projects/Manna Church/manna-church-site/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/shawnmorgan/Desktop/Projects/Manna Church/manna-church-site/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/draft.ts",
			"pathname": "/api/draft",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/preview.ts",
...
var _page3 = () => import("./chunks/index_BDp7cK6N.mjs");
